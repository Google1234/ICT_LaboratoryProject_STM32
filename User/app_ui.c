...
uint8_t all_page_boardtest = (TEST_NUM+7)/8 ;		//每页显示8个实验,+7是因为使用进一法
...
//	"LED测试程序运行中:正常现象: LED1 LE2 LED3 轮流闪烁",
//	"按键测试程序运行中:正常现象:KEY1控制LED1反转,KEY2控制LE2反转",
//	"EEPROM测试程序运行中",
//	"FLASH测试程序运行中",
//	"实验现象:液晶出现十字交叉，用画笔点击十字交叉进行触摸屏校正",
//	"",
//	
//	
//};
